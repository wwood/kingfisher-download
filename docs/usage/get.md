...
**-m**, **\--download-methods** {aws-http,prefetch,aws-cp,gcp-cp,ena-ascp,ena-ftp,ngdc-ascp,ngdc-http} [{aws-http,prefetch,aws-cp,gcp-cp,ena-ascp,ena-ftp,ngdc-ascp,ngdc-http} \...]
